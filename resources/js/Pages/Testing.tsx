    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400 mt-2 pt-2 border-t border-gray-200 dark:border-gray-700">
                ...
                <span className="text-yellow-600 dark:text-yellow-400">30–59 = Uncertain</span>
                <span className="text-red-600 dark:text-red-400">60+ = AI</span>
            </div>
        </div>
    );
}
            ...
            <div className="max-w-5xl mx-auto space-y-10">
                ...
                <div>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 text-sm text-blue-900 dark:text-blue-200 leading-relaxed">
                        <strong>Controlled experiment:</strong> All text samples cover the same topic &mdash; the Paris COP21 climate agreement (December 2015) &mdash; to eliminate domain vocabulary as a confounding variable. Human articles are sourced from <em>The Conversation</em> (academic journalism, published Nov&ndash;Dec 2015). AI samples were generated by Claude, Gemini, and ChatGPT with the same prompt requesting academic-style essays on 10 COP21 sub-topics.
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                            Each sample is run through 11 pattern detectors and 8 linguistic analysers. The weighted sum produces a score from 0&ndash;100.
                        </p>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-amber-800 dark:text-amber-300 space-y-1.5 leading-relaxed list-disc list-inside">
                        <li><strong>Small sample size:</strong> 40 texts (10 per source) is sufficient for directional insights but not statistically robust. Results should be interpreted as calibration data, not definitive accuracy claims.</li>
                        <li><strong>Single topic:</strong> All samples cover COP21. Accuracy may differ on other domains, particularly creative writing, fiction, or technical content.</li>
                        ...
                        <li><strong>Calibration in progress:</strong> The AI detection threshold ({thresholds.ai}) is set high to avoid false positives. Current AI samples score in the 19&ndash;42 range, indicating the threshold needs adjustment as the detector matures.</li>
                    </ul>
                </div>
            </div>
        </AppLayout>
