            ...
            <div className="max-w-5xl mx-auto space-y-10">
                ...
                <div>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 text-sm text-blue-900 dark:text-blue-200 leading-relaxed">
                        <strong>Empirical validation:</strong> The detector is calibrated against <strong>{overall.total} fixture texts</strong> spanning <strong>7 genres</strong> &mdash; academic essays, creative fiction, student opinion editorials, personal reflective essays, book and film reviews, technical/explanatory writing, and creative nonfiction memoir. Each genre includes human-authored samples from verified published sources alongside matched AI-generated versions from Claude, Gemini, and ChatGPT. Within each genre, human and AI authors write on the same topics to isolate writing style as the differentiator.
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 mb-6">
                        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Test Design</h4>
                            <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                For each genre, human-authored texts are sourced from verified published sources. AI versions are generated by giving each model the same topic synopsis and style constraints. This matched-pair design ensures that any score difference reflects writing style, not subject matter. Each genre is tested independently to identify where the detector performs best and worst.
                            </p>
                        </div>
                        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Fixture Corpus</h4>
                            <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1.5">
                                <li><strong>Academic essays</strong> &mdash; climate policy (The Conversation, 2015)</li>
                                <li><strong>Creative fiction</strong> &mdash; SF/fantasy (Clarkesworld, Lightspeed Magazine)</li>
                                <li><strong>Student opinion</strong> &mdash; editorials (Harvard Crimson, Daily Pennsylvanian)</li>
                                <li><strong>Personal essays</strong> &mdash; college admissions (Johns Hopkins, Connecticut College)</li>
                                <li><strong>Book/film reviews</strong> &mdash; criticism (Harvard Crimson, Oxford Student, Oxford Blue)</li>
                                <li><strong>Technical writing</strong> &mdash; explainers (Science News Explores, Compound Interest, freeCodeCamp)</li>
                                <li><strong>Creative nonfiction</strong> &mdash; memoir (Brevity Magazine)</li>
                            </ul>
                            <p className="text-xs text-gray-500 dark:text-gray-500 mt-2">Each genre &times; 4 sources (human, Claude, Gemini, ChatGPT)</p>
                        </div>
                    </div>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-amber-800 dark:text-amber-300 space-y-1.5 leading-relaxed list-disc list-inside">
                        <li><strong>Current accuracy:</strong> 52.9% overall accuracy, with 40.2% AI detection rate and 91.2% human pass rate. The system is conservative &mdash; it strongly avoids false positives on human text at the cost of missing some AI text.</li>
                        <li><strong>Genre coverage:</strong> The corpus spans 7 genres but accuracy may still differ on domains not represented (e.g. legal writing, poetry, code documentation).</li>
                ...
                <div>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Human Text Sources</h3>
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-5">
                        <div className="space-y-4 text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                            <div>
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Academic Essays</h4>
                                <ul className="list-disc list-inside space-y-0.5">
                                    <li>Various authors. <em>The Conversation</em>, Nov&ndash;Dec 2015. 10 articles on the Paris COP21 climate agreement.</li>
                                    <li>Obama, B. &ldquo;Statement by the President on the Paris Climate Agreement.&rdquo; Office of the Press Secretary, The White House, Dec 12, 2015.</li>
                                </ul>
                            </div>
                            <div>
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Creative Fiction</h4>
                                <ul className="list-disc list-inside space-y-0.5">
                                    <li>Kritzer, N. &ldquo;Better Living Through Algorithms.&rdquo; <em>Clarkesworld Magazine</em> #200, May 2023. (2024 Hugo Award Winner)</li>
                                    <li>Kim, I.J. &ldquo;Day Ten Thousand.&rdquo; <em>Clarkesworld Magazine</em> #201, Jun 2023.</li>
                                    <li>Jones, R.K. &ldquo;Five Views of the Planet Tartarus.&rdquo; <em>Lightspeed Magazine</em> #164, Jan 2024.</li>
                                    <li>Leong, S. &ldquo;A Saint Between the Teeth.&rdquo; <em>Lightspeed Magazine</em> #164, Jan 2024.</li>
                                </ul>
                            </div>
                            <div>
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Student Opinion &amp; Editorials</h4>
                                <ul className="list-disc list-inside space-y-0.5">
                                    <li>Nekritz, M.E. &ldquo;Dissent: Harvard College Needs a King.&rdquo; <em>The Harvard Crimson</em>, Apr 5, 2024.</li>
                                    <li>Knight, D.L.J. &ldquo;AI is Changing our World.&rdquo; <em>The Harvard Crimson</em>, Oct 30, 2024.</li>
                                    <li>Ramirez, E. &ldquo;This just in! Penn Face zombie outbreak!&rdquo; <em>The Daily Pennsylvanian</em>, Nov 5, 2024.</li>
                                    <li>Slinka-Petka, P. &ldquo;Speak up, own your vote.&rdquo; <em>The Daily Pennsylvanian</em>, Nov 7, 2024.</li>
                                </ul>
                            </div>
                            <div>
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Personal / Reflective Essays</h4>
                                <ul className="list-disc list-inside space-y-0.5">
                                    <li>Faith W. &ldquo;Conquering.&rdquo; Johns Hopkins University, <em>Essays That Worked</em> (Class of 2029).</li>
                                    <li>Emily O. &ldquo;A Splash of Color.&rdquo; Johns Hopkins University, <em>Essays That Worked</em> (Class of 2029).</li>
                                    <li>Owusu, N. Connecticut College, <em>Essays That Worked</em> (Class of 2028).</li>
                                    <li>Hughes, P. Connecticut College, <em>Essays That Worked</em> (Class of 2028).</li>
                                </ul>
                            </div>
                            <div>
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Book &amp; Film Reviews</h4>
                                <ul className="list-disc list-inside space-y-0.5">
                                    <li>Liu, A. &ldquo;&lsquo;Imaginary&rsquo; Review.&rdquo; <em>The Harvard Crimson</em>, Apr 4, 2024.</li>
                                    <li>Wayne, C.S. &ldquo;&lsquo;Heretic&rsquo; Review.&rdquo; <em>The Harvard Crimson</em>, Nov 21, 2024.</li>
                                    <li>Kuehl, R. &ldquo;The Return (2024): A Review.&rdquo; <em>The Oxford Student</em>, May 26, 2025.</li>
                                    <li>Stone, G. &ldquo;Orbital by Samantha Harvey review.&rdquo; <em>The Oxford Blue</em>, Jan 23, 2025.</li>
                                </ul>
                            </div>
                            <div>
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Technical / Explanatory Writing</h4>
                                <ul className="list-disc list-inside space-y-0.5">
                                    <li>Brookshire, B. &ldquo;Explainer: How photosynthesis works.&rdquo; <em>Science News Explores</em>, Oct 28, 2020.</li>
                                    <li>Brunning, A. &ldquo;Baking Bread: The Chemistry of Bread-Making.&rdquo; <em>Compound Interest</em>, Jan 13, 2016.</li>
                                    <li>Polesny, O. &ldquo;How to Start Unit Testing Your JavaScript Code.&rdquo; <em>freeCodeCamp</em>, Mar 24, 2020.</li>
                                    <li>Abba, I. &ldquo;Git and GitHub Tutorial.&rdquo; <em>freeCodeCamp</em>, Nov 5, 2021.</li>
                                </ul>
                            </div>
                            <div>
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Creative Nonfiction / Memoir</h4>
                                <ul className="list-disc list-inside space-y-0.5">
                                    <li>Gottlieb, D. &ldquo;Where the Dust Goes.&rdquo; <em>Brevity Magazine</em> #77, Sep 14, 2024.</li>
                                    <li>Simacek, C. &ldquo;Jiaozi.&rdquo; <em>Brevity Magazine</em> #77, Sep 14, 2024.</li>
                                    <li>Jabini, E. &ldquo;I Hear You Man.&rdquo; <em>Brevity Magazine</em> #77, Sep 14, 2024.</li>
                                    <li>Wallace, W.E. &ldquo;Return Journey.&rdquo; <em>Brevity Magazine</em> #77, Sep 14, 2024.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
